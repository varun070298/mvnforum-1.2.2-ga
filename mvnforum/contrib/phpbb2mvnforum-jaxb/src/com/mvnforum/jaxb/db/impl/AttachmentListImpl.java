...
public class AttachmentListImpl implements com.mvnforum.jaxb.db.AttachmentList, com.sun.xml.bind.JAXBObject, com.mvnforum.jaxb.db.impl.runtime.UnmarshallableObject, com.mvnforum.jaxb.db.impl.runtime.XMLSerializable, com.mvnforum.jaxb.db.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Attachment;
    public final static java.lang.Class version = (com.mvnforum.jaxb.db.impl.JAXBVersion.class);
    private static com.sun.msv.grammar.Grammar schemaFragment;

    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.mvnforum.jaxb.db.AttachmentList.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getAttachment() {
        if (_Attachment == null) {
            _Attachment = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Attachment;
    }
    ...
    public com.mvnforum.jaxb.db.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.mvnforum.jaxb.db.impl.runtime.UnmarshallingContext context) {
        return new com.mvnforum.jaxb.db.impl.AttachmentListImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_Attachment == null)? 0 :_Attachment.size());
        while (idx1 != len1) {
            context.startElement("", "Attachment");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Attachment.get(idx_0 ++)), "Attachment");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Attachment.get(idx_1 ++)), "Attachment");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Attachment.get(idx1 ++)), "Attachment");
            context.endElement();
        }
    }
...
+"\u0000\u001at\u0000#com.mvnforum.jaxb.db.AttachmentTypet\u0000+http://java.sun.c"
+"om/jaxb/xjc/dummy-elementssq\u0000~\u0000\u0000ppsq\u0000~\u0000\u0014q\u0000~\u0000\npsr\u0000\u001bcom.sun.ms"
...
+"\u0000\u001et\u0000\nAttachmentt\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com.sun.msv.grammar.ExpressionPoo"
...
+"msv/grammar/ExpressionPool;xp\u0000\u0000\u0000\u0006\u0001pq\u0000~\u0000\u0005q\u0000~\u0000\u0012q\u0000~\u0000\u0010q\u0000~\u0000#q\u0000~\u0000\b"
+"q\u0000~\u0000\u0013x"));
        }
        ...
        extends com.mvnforum.jaxb.db.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.mvnforum.jaxb.db.impl.AttachmentListImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("MemberName" == ___local)&&("" == ___uri)) {
                            _getAttachment().add(((com.mvnforum.jaxb.db.impl.AttachmentTypeImpl) spawnChildFromEnterElement((com.mvnforum.jaxb.db.impl.AttachmentTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }

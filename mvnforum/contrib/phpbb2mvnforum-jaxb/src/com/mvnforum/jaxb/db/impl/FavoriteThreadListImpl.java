...
public class FavoriteThreadListImpl implements com.mvnforum.jaxb.db.FavoriteThreadList, com.sun.xml.bind.JAXBObject, com.mvnforum.jaxb.db.impl.runtime.UnmarshallableObject, com.mvnforum.jaxb.db.impl.runtime.XMLSerializable, com.mvnforum.jaxb.db.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _FavoriteThread;
    public final static java.lang.Class version = (com.mvnforum.jaxb.db.impl.JAXBVersion.class);
    private static com.sun.msv.grammar.Grammar schemaFragment;

    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.mvnforum.jaxb.db.FavoriteThreadList.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getFavoriteThread() {
        if (_FavoriteThread == null) {
            _FavoriteThread = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _FavoriteThread;
    }

    public java.util.List getFavoriteThread() {
        return _getFavoriteThread();
    }
    ...
    public com.mvnforum.jaxb.db.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.mvnforum.jaxb.db.impl.runtime.UnmarshallingContext context) {
        return new com.mvnforum.jaxb.db.impl.FavoriteThreadListImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_FavoriteThread == null)? 0 :_FavoriteThread.size());
        while (idx1 != len1) {
            context.startElement("", "FavoriteThread");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _FavoriteThread.get(idx_0 ++)), "FavoriteThread");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _FavoriteThread.get(idx_1 ++)), "FavoriteThread");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _FavoriteThread.get(idx1 ++)), "FavoriteThread");
            context.endElement();
        }
    }
...
+"\u0000\u001at\u0000\'com.mvnforum.jaxb.db.FavoriteThreadTypet\u0000+http://java.s"
...
+"sq\u0000~\u0000\u001et\u0000\u000eFavoriteThreadt\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com.sun.msv.grammar.Expre"
...
+"~\u0000#q\u0000~\u0000\bq\u0000~\u0000\u0013x"));
        ...
        extends com.mvnforum.jaxb.db.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.mvnforum.jaxb.db.impl.FavoriteThreadListImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("MemberName" == ___local)&&("" == ___uri)) {
                            _getFavoriteThread().add(((com.mvnforum.jaxb.db.impl.FavoriteThreadTypeImpl) spawnChildFromEnterElement((com.mvnforum.jaxb.db.impl.FavoriteThreadTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  0 :

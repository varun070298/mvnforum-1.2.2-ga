...
public class GlobalWatchListImpl implements com.mvnforum.jaxb.db.GlobalWatchList, com.sun.xml.bind.JAXBObject, com.mvnforum.jaxb.db.impl.runtime.UnmarshallableObject, com.mvnforum.jaxb.db.impl.runtime.XMLSerializable, com.mvnforum.jaxb.db.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _GlobalWatch;
    public final static java.lang.Class version = (com.mvnforum.jaxb.db.impl.JAXBVersion.class);
    private static com.sun.msv.grammar.Grammar schemaFragment;

    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.mvnforum.jaxb.db.GlobalWatchList.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getGlobalWatch() {
        if (_GlobalWatch == null) {
            _GlobalWatch = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _GlobalWatch;
    }

    public java.util.List getGlobalWatch() {
        return _getGlobalWatch();
    }
    ...
    public com.mvnforum.jaxb.db.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.mvnforum.jaxb.db.impl.runtime.UnmarshallingContext context) {
        return new com.mvnforum.jaxb.db.impl.GlobalWatchListImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_GlobalWatch == null)? 0 :_GlobalWatch.size());
        while (idx1 != len1) {
            context.startElement("", "GlobalWatch");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _GlobalWatch.get(idx_0 ++)), "GlobalWatch");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _GlobalWatch.get(idx_1 ++)), "GlobalWatch");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _GlobalWatch.get(idx1 ++)), "GlobalWatch");
            context.endElement();
        }
    }
...
+"\u0000\u001at\u0000$com.mvnforum.jaxb.db.GlobalWatchTypet\u0000+http://java.sun."
...
+"~\u0000\u001et\u0000\u000bGlobalWatcht\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com.sun.msv.grammar.ExpressionP"
...
+"\u0000\bq\u0000~\u0000\u0013x"));
        ...
        extends com.mvnforum.jaxb.db.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.mvnforum.jaxb.db.impl.GlobalWatchListImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("WatchType" == ___local)&&("" == ___uri)) {
                            _getGlobalWatch().add(((com.mvnforum.jaxb.db.impl.GlobalWatchTypeImpl) spawnChildFromEnterElement((com.mvnforum.jaxb.db.impl.GlobalWatchTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        ...
                        continue outer;
                    case  1 :
                        _getGlobalWatch().add(((com.mvnforum.jaxb.db.impl.GlobalWatchTypeImpl) spawnChildFromLeaveElement((com.mvnforum.jaxb.db.impl.GlobalWatchTypeImpl.class), 2, ___uri, ___local, ___qname)));
                        return ;
                    case  3 :
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        ...
                        continue outer;
                    case  1 :
                        _getGlobalWatch().add(((com.mvnforum.jaxb.db.impl.GlobalWatchTypeImpl) spawnChildFromEnterAttribute((com.mvnforum.jaxb.db.impl.GlobalWatchTypeImpl.class), 2, ___uri, ___local, ___qname)));
                        return ;
                    case  3 :
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        ...
                        continue outer;
                    case  1 :
                        _getGlobalWatch().add(((com.mvnforum.jaxb.db.impl.GlobalWatchTypeImpl) spawnChildFromLeaveAttribute((com.mvnforum.jaxb.db.impl.GlobalWatchTypeImpl.class), 2, ___uri, ___local, ___qname)));
                        return ;
                    case  3 :
                ...
                try {
                    switch (state) {
                        case  0 :
                            ...
                            continue outer;
                        case  1 :
                            _getGlobalWatch().add(((com.mvnforum.jaxb.db.impl.GlobalWatchTypeImpl) spawnChildFromText((com.mvnforum.jaxb.db.impl.GlobalWatchTypeImpl.class), 2, value)));
                            return ;
                        case  3 :

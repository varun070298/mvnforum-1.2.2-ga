...
public class GroupForumPermissionListImpl implements com.mvnforum.jaxb.db.GroupForumPermissionList, com.sun.xml.bind.JAXBObject, com.mvnforum.jaxb.db.impl.runtime.UnmarshallableObject, com.mvnforum.jaxb.db.impl.runtime.XMLSerializable, com.mvnforum.jaxb.db.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _GroupForumPermission;
    public final static java.lang.Class version = (com.mvnforum.jaxb.db.impl.JAXBVersion.class);
    private static com.sun.msv.grammar.Grammar schemaFragment;

    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.mvnforum.jaxb.db.GroupForumPermissionList.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getGroupForumPermission() {
        if (_GroupForumPermission == null) {
            _GroupForumPermission = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _GroupForumPermission;
    }

    public java.util.List getGroupForumPermission() {
        return _getGroupForumPermission();
    }
    ...
    public com.mvnforum.jaxb.db.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.mvnforum.jaxb.db.impl.runtime.UnmarshallingContext context) {
        return new com.mvnforum.jaxb.db.impl.GroupForumPermissionListImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_GroupForumPermission == null)? 0 :_GroupForumPermission.size());
        while (idx1 != len1) {
            context.startElement("", "GroupForumPermission");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _GroupForumPermission.get(idx_0 ++)), "GroupForumPermission");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _GroupForumPermission.get(idx_1 ++)), "GroupForumPermission");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _GroupForumPermission.get(idx1 ++)), "GroupForumPermission");
            context.endElement();
        }
    }
...
+"\u0000\u001at\u0000-com.mvnforum.jaxb.db.GroupForumPermissionTypet\u0000+http://"
...
+"eq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u0014GroupForumPermissiont\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com.sun.msv.g"
...
+"q\u0000~\u0000\u0012q\u0000~\u0000\u0010q\u0000~\u0000#q\u0000~\u0000\bq\u0000~\u0000\u0013x"));
        ...
        extends com.mvnforum.jaxb.db.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.mvnforum.jaxb.db.impl.GroupForumPermissionListImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("GroupName" == ___local)&&("" == ___uri)) {
                            _getGroupForumPermission().add(((com.mvnforum.jaxb.db.impl.GroupForumPermissionTypeImpl) spawnChildFromEnterElement((com.mvnforum.jaxb.db.impl.GroupForumPermissionTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  3 :

...
public class GroupMemberListImpl implements com.mvnforum.jaxb.db.GroupMemberList, com.sun.xml.bind.JAXBObject, com.mvnforum.jaxb.db.impl.runtime.UnmarshallableObject, com.mvnforum.jaxb.db.impl.runtime.XMLSerializable, com.mvnforum.jaxb.db.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _GroupMember;
    public final static java.lang.Class version = (com.mvnforum.jaxb.db.impl.JAXBVersion.class);
    private static com.sun.msv.grammar.Grammar schemaFragment;

    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.mvnforum.jaxb.db.GroupMemberList.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getGroupMember() {
        if (_GroupMember == null) {
            _GroupMember = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _GroupMember;
    }

    public java.util.List getGroupMember() {
        return _getGroupMember();
    }
    ...
    public com.mvnforum.jaxb.db.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.mvnforum.jaxb.db.impl.runtime.UnmarshallingContext context) {
        return new com.mvnforum.jaxb.db.impl.GroupMemberListImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_GroupMember == null)? 0 :_GroupMember.size());
        while (idx1 != len1) {
            context.startElement("", "GroupMember");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _GroupMember.get(idx_0 ++)), "GroupMember");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _GroupMember.get(idx_1 ++)), "GroupMember");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _GroupMember.get(idx1 ++)), "GroupMember");
            context.endElement();
        }
    }
...
+"\u0000\u001at\u0000$com.mvnforum.jaxb.db.GroupMemberTypet\u0000+http://java.sun."
...
+"~\u0000\u001et\u0000\u000bGroupMembert\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com.sun.msv.grammar.ExpressionP"
...
+"\u0000\bq\u0000~\u0000\u0013x"));
        ...
        extends com.mvnforum.jaxb.db.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.mvnforum.jaxb.db.impl.GroupMemberListImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("MemberName" == ___local)&&("" == ___uri)) {
                            _getGroupMember().add(((com.mvnforum.jaxb.db.impl.GroupMemberTypeImpl) spawnChildFromEnterElement((com.mvnforum.jaxb.db.impl.GroupMemberTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  0 :

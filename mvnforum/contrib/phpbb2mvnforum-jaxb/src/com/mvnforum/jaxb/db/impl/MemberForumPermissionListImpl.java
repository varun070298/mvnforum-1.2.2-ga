...
public class MemberForumPermissionListImpl implements com.mvnforum.jaxb.db.MemberForumPermissionList, com.sun.xml.bind.JAXBObject, com.mvnforum.jaxb.db.impl.runtime.UnmarshallableObject, com.mvnforum.jaxb.db.impl.runtime.XMLSerializable, com.mvnforum.jaxb.db.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _MemberForumPermission;
    public final static java.lang.Class version = (com.mvnforum.jaxb.db.impl.JAXBVersion.class);
    private static com.sun.msv.grammar.Grammar schemaFragment;

    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.mvnforum.jaxb.db.MemberForumPermissionList.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getMemberForumPermission() {
        if (_MemberForumPermission == null) {
            _MemberForumPermission = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _MemberForumPermission;
    }

    public java.util.List getMemberForumPermission() {
        return _getMemberForumPermission();
    }
    ...
    public com.mvnforum.jaxb.db.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.mvnforum.jaxb.db.impl.runtime.UnmarshallingContext context) {
        return new com.mvnforum.jaxb.db.impl.MemberForumPermissionListImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_MemberForumPermission == null)? 0 :_MemberForumPermission.size());
        while (idx1 != len1) {
            context.startElement("", "MemberForumPermission");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _MemberForumPermission.get(idx_0 ++)), "MemberForumPermission");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _MemberForumPermission.get(idx_1 ++)), "MemberForumPermission");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _MemberForumPermission.get(idx1 ++)), "MemberForumPermission");
            context.endElement();
        }
    }
...
+"\u0000\u001at\u0000.com.mvnforum.jaxb.db.MemberForumPermissionTypet\u0000+http:/"
...
+"ceq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u0015MemberForumPermissiont\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com.sun.msv"
...
+"\u0000\u0005q\u0000~\u0000\u0012q\u0000~\u0000\u0010q\u0000~\u0000#q\u0000~\u0000\bq\u0000~\u0000\u0013x"));
        ...
        extends com.mvnforum.jaxb.db.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.mvnforum.jaxb.db.impl.MemberForumPermissionListImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("MemberName" == ___local)&&("" == ___uri)) {
                            _getMemberForumPermission().add(((com.mvnforum.jaxb.db.impl.MemberForumPermissionTypeImpl) spawnChildFromEnterElement((com.mvnforum.jaxb.db.impl.MemberForumPermissionTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                    case  3 :

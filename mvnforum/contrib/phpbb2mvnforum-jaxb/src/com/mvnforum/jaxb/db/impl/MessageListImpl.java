...
public class MessageListImpl implements com.mvnforum.jaxb.db.MessageList, com.sun.xml.bind.JAXBObject, com.mvnforum.jaxb.db.impl.runtime.UnmarshallableObject, com.mvnforum.jaxb.db.impl.runtime.XMLSerializable, com.mvnforum.jaxb.db.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Message;
    public final static java.lang.Class version = (com.mvnforum.jaxb.db.impl.JAXBVersion.class);
    private static com.sun.msv.grammar.Grammar schemaFragment;

    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.mvnforum.jaxb.db.MessageList.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getMessage() {
        if (_Message == null) {
            _Message = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Message;
    }
    ...
    public com.mvnforum.jaxb.db.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.mvnforum.jaxb.db.impl.runtime.UnmarshallingContext context) {
        return new com.mvnforum.jaxb.db.impl.MessageListImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        while (idx1 != len1) {
            ...
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Message.get(idx_0 ++)), "Message");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Message.get(idx_1 ++)), "Message");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Message.get(idx1 ++)), "Message");
            context.endElement();
        }
    }
...
+"\u0000\u001at\u0000 com.mvnforum.jaxb.db.MessageTypet\u0000+http://java.sun.com/"
...
+"\u0000\u0007Messaget\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000"
...
+"ammar/ExpressionPool;xp\u0000\u0000\u0000\u0006\u0001pq\u0000~\u0000\u0005q\u0000~\u0000\u0012q\u0000~\u0000\u0010q\u0000~\u0000#q\u0000~\u0000\bq\u0000~\u0000\u0013x"));
        ...
        extends com.mvnforum.jaxb.db.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.mvnforum.jaxb.db.impl.MessageListImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("FolderName" == ___local)&&("" == ___uri)) {
                            _getMessage().add(((com.mvnforum.jaxb.db.impl.MessageTypeImpl) spawnChildFromEnterElement((com.mvnforum.jaxb.db.impl.MessageTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    case  2 :
                        ...
                        break;
                    case  1 :
                        _getMessage().add(((com.mvnforum.jaxb.db.impl.MessageTypeImpl) spawnChildFromLeaveElement((com.mvnforum.jaxb.db.impl.MessageTypeImpl.class), 2, ___uri, ___local, ___qname)));
                        return ;
                    case  0 :
                        state = 3;
                        continue outer;
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        _getMessage().add(((com.mvnforum.jaxb.db.impl.MessageTypeImpl) spawnChildFromEnterAttribute((com.mvnforum.jaxb.db.impl.MessageTypeImpl.class), 2, ___uri, ___local, ___qname)));
                        return ;
                    case  0 :
                        state = 3;
                        continue outer;
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    case  1 :
                        _getMessage().add(((com.mvnforum.jaxb.db.impl.MessageTypeImpl) spawnChildFromLeaveAttribute((com.mvnforum.jaxb.db.impl.MessageTypeImpl.class), 2, ___uri, ___local, ___qname)));
                        return ;
                    case  0 :
                        state = 3;
                        continue outer;
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                try {
                    switch (state) {
                        case  1 :
                            _getMessage().add(((com.mvnforum.jaxb.db.impl.MessageTypeImpl) spawnChildFromText((com.mvnforum.jaxb.db.impl.MessageTypeImpl.class), 2, value)));
                            return ;
                        case  0 :
                            state = 3;
                            continue outer;

...
public class PostListImpl implements com.mvnforum.jaxb.db.PostList, com.sun.xml.bind.JAXBObject, com.mvnforum.jaxb.db.impl.runtime.UnmarshallableObject, com.mvnforum.jaxb.db.impl.runtime.XMLSerializable, com.mvnforum.jaxb.db.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Post;
    public final static java.lang.Class version = (com.mvnforum.jaxb.db.impl.JAXBVersion.class);
    private static com.sun.msv.grammar.Grammar schemaFragment;

    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.mvnforum.jaxb.db.PostList.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getPost() {
        if (_Post == null) {
            _Post = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Post;
    }

    public java.util.List getPost() {
        return _getPost();
    }
    ...
    public com.mvnforum.jaxb.db.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.mvnforum.jaxb.db.impl.runtime.UnmarshallingContext context) {
        return new com.mvnforum.jaxb.db.impl.PostListImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_Post == null)? 0 :_Post.size());
        while (idx1 != len1) {
            context.startElement("", "Post");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Post.get(idx_0 ++)), "Post");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Post.get(idx_1 ++)), "Post");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Post.get(idx1 ++)), "Post");
            context.endElement();
        }
    }
...
+"\u0000\u001at\u0000\u001dcom.mvnforum.jaxb.db.PostTypet\u0000+http://java.sun.com/jax"
...
+"ostt\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001"
...
+"ExpressionPool;xp\u0000\u0000\u0000\u0006\u0001pq\u0000~\u0000\u0005q\u0000~\u0000\u0012q\u0000~\u0000\u0010q\u0000~\u0000#q\u0000~\u0000\bq\u0000~\u0000\u0013x"));
        ...
        extends com.mvnforum.jaxb.db.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.mvnforum.jaxb.db.impl.PostListImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("MemberName" == ___local)&&("" == ___uri)) {
                            _getPost().add(((com.mvnforum.jaxb.db.impl.PostTypeImpl) spawnChildFromEnterElement((com.mvnforum.jaxb.db.impl.PostTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }

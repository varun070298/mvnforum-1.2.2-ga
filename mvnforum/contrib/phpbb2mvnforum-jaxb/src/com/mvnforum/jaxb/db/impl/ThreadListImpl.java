...
public class ThreadListImpl implements com.mvnforum.jaxb.db.ThreadList, com.sun.xml.bind.JAXBObject, com.mvnforum.jaxb.db.impl.runtime.UnmarshallableObject, com.mvnforum.jaxb.db.impl.runtime.XMLSerializable, com.mvnforum.jaxb.db.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _Thread;
    public final static java.lang.Class version = (com.mvnforum.jaxb.db.impl.JAXBVersion.class);
    private static com.sun.msv.grammar.Grammar schemaFragment;

    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.mvnforum.jaxb.db.ThreadList.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getThread() {
        if (_Thread == null) {
            _Thread = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _Thread;
    }

    public java.util.List getThread() {
        return _getThread();
    }
    ...
    public com.mvnforum.jaxb.db.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.mvnforum.jaxb.db.impl.runtime.UnmarshallingContext context) {
        return new com.mvnforum.jaxb.db.impl.ThreadListImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_Thread == null)? 0 :_Thread.size());
        while (idx1 != len1) {
            context.startElement("", "Thread");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _Thread.get(idx_0 ++)), "Thread");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _Thread.get(idx_1 ++)), "Thread");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _Thread.get(idx1 ++)), "Thread");
            context.endElement();
        }
    }
...
+"\u0000\u001at\u0000\u001fcom.mvnforum.jaxb.db.ThreadTypet\u0000+http://java.sun.com/j"
...
+"\u0006Threadt\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000"
...
+"mar/ExpressionPool;xp\u0000\u0000\u0000\u0006\u0001pq\u0000~\u0000\u0005q\u0000~\u0000\u0012q\u0000~\u0000\u0010q\u0000~\u0000#q\u0000~\u0000\bq\u0000~\u0000\u0013x"));
        ...
        extends com.mvnforum.jaxb.db.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.mvnforum.jaxb.db.impl.ThreadListImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("MemberName" == ___local)&&("" == ___uri)) {
                            _getThread().add(((com.mvnforum.jaxb.db.impl.ThreadTypeImpl) spawnChildFromEnterElement((com.mvnforum.jaxb.db.impl.ThreadTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }

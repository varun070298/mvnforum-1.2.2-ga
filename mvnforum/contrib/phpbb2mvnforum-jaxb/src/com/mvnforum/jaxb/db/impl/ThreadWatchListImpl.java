...
public class ThreadWatchListImpl implements com.mvnforum.jaxb.db.ThreadWatchList, com.sun.xml.bind.JAXBObject, com.mvnforum.jaxb.db.impl.runtime.UnmarshallableObject, com.mvnforum.jaxb.db.impl.runtime.XMLSerializable, com.mvnforum.jaxb.db.impl.runtime.ValidatableObject
{

    protected com.sun.xml.bind.util.ListImpl _ThreadWatch;
    public final static java.lang.Class version = (com.mvnforum.jaxb.db.impl.JAXBVersion.class);
    private static com.sun.msv.grammar.Grammar schemaFragment;

    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (com.mvnforum.jaxb.db.ThreadWatchList.class);
    }

    protected com.sun.xml.bind.util.ListImpl _getThreadWatch() {
        if (_ThreadWatch == null) {
            _ThreadWatch = new com.sun.xml.bind.util.ListImpl(new java.util.ArrayList());
        }
        return _ThreadWatch;
    }

    public java.util.List getThreadWatch() {
        return _getThreadWatch();
    }
    ...
    public com.mvnforum.jaxb.db.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.mvnforum.jaxb.db.impl.runtime.UnmarshallingContext context) {
        return new com.mvnforum.jaxb.db.impl.ThreadWatchListImpl.Unmarshaller(context);
    }
    ...
    {
        int idx1 = 0;
        final int len1 = ((_ThreadWatch == null)? 0 :_ThreadWatch.size());
        while (idx1 != len1) {
            context.startElement("", "ThreadWatch");
            int idx_0 = idx1;
            context.childAsURIs(((com.sun.xml.bind.JAXBObject) _ThreadWatch.get(idx_0 ++)), "ThreadWatch");
            context.endNamespaceDecls();
            int idx_1 = idx1;
            context.childAsAttributes(((com.sun.xml.bind.JAXBObject) _ThreadWatch.get(idx_1 ++)), "ThreadWatch");
            context.endAttributes();
            context.childAsBody(((com.sun.xml.bind.JAXBObject) _ThreadWatch.get(idx1 ++)), "ThreadWatch");
            context.endElement();
        }
    }
...
+"\u0000\u001at\u0000$com.mvnforum.jaxb.db.ThreadWatchTypet\u0000+http://java.sun."
...
+"~\u0000\u001et\u0000\u000bThreadWatcht\u0000\u0000q\u0000~\u0000\u001dsr\u0000\"com.sun.msv.grammar.ExpressionP"
...
+"\u0000\bq\u0000~\u0000\u0013x"));
        ...
        extends com.mvnforum.jaxb.db.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return com.mvnforum.jaxb.db.impl.ThreadWatchListImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("MemberName" == ___local)&&("" == ___uri)) {
                            _getThreadWatch().add(((com.mvnforum.jaxb.db.impl.ThreadWatchTypeImpl) spawnChildFromEnterElement((com.mvnforum.jaxb.db.impl.ThreadWatchTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        ...
                        continue outer;
                    case  1 :
                        _getThreadWatch().add(((com.mvnforum.jaxb.db.impl.ThreadWatchTypeImpl) spawnChildFromLeaveElement((com.mvnforum.jaxb.db.impl.ThreadWatchTypeImpl.class), 2, ___uri, ___local, ___qname)));
                        return ;
                    case  3 :
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        ...
                        continue outer;
                    case  1 :
                        _getThreadWatch().add(((com.mvnforum.jaxb.db.impl.ThreadWatchTypeImpl) spawnChildFromEnterAttribute((com.mvnforum.jaxb.db.impl.ThreadWatchTypeImpl.class), 2, ___uri, ___local, ___qname)));
                        return ;
                    case  3 :
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        ...
                        continue outer;
                    case  1 :
                        _getThreadWatch().add(((com.mvnforum.jaxb.db.impl.ThreadWatchTypeImpl) spawnChildFromLeaveAttribute((com.mvnforum.jaxb.db.impl.ThreadWatchTypeImpl.class), 2, ___uri, ___local, ___qname)));
                        return ;
                    case  3 :
                ...
                try {
                    switch (state) {
                        case  0 :
                            ...
                            continue outer;
                        case  1 :
                            _getThreadWatch().add(((com.mvnforum.jaxb.db.impl.ThreadWatchTypeImpl) spawnChildFromText((com.mvnforum.jaxb.db.impl.ThreadWatchTypeImpl.class), 2, value)));
                            return ;
                        case  3 :

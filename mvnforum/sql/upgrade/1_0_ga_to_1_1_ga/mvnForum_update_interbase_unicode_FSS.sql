/*
-- $Header: /cvsroot/mvnforum/mvnforum/sql/upgrade/1_0_ga_to_1_1_ga/mvnForum_update_interbase_unicode_FSS.sql,v 1.5 2008/01/14 09:50:09 minhnn Exp $
-- $Author: minhnn $
-- $Revision: 1.5 $
...
ALTER TABLE mvnforumThread ADD ThreadPriority INTEGER ;
UPDATE mvnforumThread SET ThreadPriority = 0 ;

ALTER TABLE mvnforumMember ADD MemberPasswordExpireDate TIMESTAMP NOT NULL;

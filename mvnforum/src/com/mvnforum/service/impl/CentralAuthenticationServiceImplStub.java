/*
 * $Header: /cvsroot/mvnforum/mvnforum/src/com/mvnforum/service/impl/CentralAuthenticationServiceImplStub.java,v 1.1 2008/06/12 08:33:50 tbtrung Exp $
 * $Author: tbtrung $
 * $Revision: 1.1 $
 * $Date: 2008/06/12 08:33:50 $
 *
 * ====================================================================
 *
...
public class CentralAuthenticationServiceImplStub implements CentralAuthenticationService {

    private static int count;

    public CentralAuthenticationServiceImplStub() {
        count++;

/*
 * $Header: /cvsroot/mvnforum/myvietnam/src/net/myvietnam/mvncore/taglib/FramesetTag.java,v 1.4 2007/01/15 10:31:21 dungbtm Exp $
 * $Author: dungbtm $
 * $Revision: 1.4 $
...
public class FramesetTag implements Tag {
    ...
    public int doStartTag() throws JspTagException {
        try {
            if (isPortletRequest == false) {
                pageContext.getOut().write("<frameset>");
            }
